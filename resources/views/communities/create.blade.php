...
<form method="POST" action="/create/c" enctype="multipart/form-data">
  ...
  <div class="form-group">
    <label for="c-communitydescription">Enter a url suffix for your community <span style="color:#a4a4a4; padding-left:40px;">sniddl.com/c/example</span></label>
    <input name="createcommunityurl" type="text" class="form-control" id="createcommunitydescription" placeholder="Example: Sniddl">
  </div>
