            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        ...
                        <li><a style="position:relative" href="/u/{{Auth::user()->username}}"><img class="img-circle" height="25px"  style="position:absolute; margin-top:-2px; background-color:#{{Auth::user()->color}};" src="{{ Auth::user()->avatar }}"/></a></li>
