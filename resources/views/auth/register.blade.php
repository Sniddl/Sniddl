...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-4" id="register-center">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <!--<div class="form-group">
                        ...
                        <button type="submit" class="btn btn-outline-info" style="float:right; margin-right:15px; margin-top:15px;">Register</button>
                    </form>
                </div>
            </div>
        </div>
